...
/**
 * Queries the current OpenGL context for vendor/renderer/version strings and the primary
 * monitor for its refresh rate.
 *
 ...
 * return "unknown" placeholders, since there's nothing to query yet.
 */
public final class GpuDetector {
	...
	public static GpuInfo detect() {
		...
		return new GpuInfo(vendor, renderer, glVersion, glslVersion, graphicsApi, safeGetRefreshRate());
	}
